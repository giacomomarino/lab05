...
public class RegexMatcherTest {
  ...
  public void testBrownEmails(Tester t) {
    ...
    t.checkExpect(RegexMatcher.brownEmails("first-middle_last29@brown.edu;dao_han_lim@brown.edu"), (twoEmails));

    String email2 = "dao_han_lim@brown.edu first-middle_last29@brown.edu";
    t.checkExpect(RegexMatcher.brownEmails("dao_han_lim@brown.edu first-middle_last29@brown.edu"), (email2));

   String email3 = "first-middle_last29@brown.edu dao_han_lim@brown.edu" + " a_b_c_d_e88@brown.edu";
   t.checkExpect(RegexMatcher.brownEmails("first-middle_last29@brown.edu dao_han_lim@brown.edu|a_b_c_d_e88@brown.edu//"), (email3));
  }
